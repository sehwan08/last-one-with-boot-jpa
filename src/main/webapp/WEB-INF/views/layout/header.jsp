			...
			<sec:authorize access="isAnonymous()">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="#"
						id="popular1">인기 관광지</a></li>
					<li class="nav-item"><a class="nav-link" href="#"
						id="popukar2">인기 맛집</a></li>
					<li class="nav-item"><a class="nav-link" href="/blog/blogMain"
						id="travel">여행 이야기</a></li>
			...
			<c:choose>
				<c:when test="${principal.user.role == 'ROLE_ADMIN'}">
					<sec:authorize access="hasAnyRole('ROLE_ADMIN')">
						<ul class="navbar-nav">
							...
							<li class="nav-item"><a class="nav-link"
								href="/blog/blogMain" id="travel">여행 이야기 관리</a></li>
							<li class="nav-item"><a class="nav-link"
				...
				<c:otherwise>
					<sec:authorize access="isAuthenticated()">
						<ul class="navbar-nav">
							<li class="nav-item"><a class="nav-link"
								href="/user/${principal.user.id}/update" id="update">회원 정보
									수정</a></li>
							<li class="nav-item"><a class="nav-link" href="#"
								id="popular1">인기 관광지</a></li>
							<li class="nav-item"><a class="nav-link" href="#"
								id="popukar2">인기 맛집</a></li>
							<li class="nav-item"><a class="nav-link"
								href="/blog/blogMain" id="travel">여행 이야기</a></li>
							<li class="nav-item"><a class="nav-link" href="/etc/info"
								id="corona">With Corona</a></li>
							<li class="nav-item"><a class="nav-link"
								href="/board/boardMain" id="notice">공지사항</a></li>
